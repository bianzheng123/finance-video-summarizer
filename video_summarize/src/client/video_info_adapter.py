...
from src.client.bilibili import BilibiliClient
...
class VideoInfoAdapter:
    ...
    def _get_bilibili_client(self) -> BilibiliClient:
        """延迟初始化 BilibiliClient"""
    ...
    def _get_bilibili_video_info(self, url: str) -> dict[str, Any] | None:
        ...
        try:
            client = self._get_bilibili_client()

            # 使用 bilibili_api 获取视频信息
            v = video.Video(bvid=bvid, credential=client.credential)
